...
dag = DAG(
    "dbt_transform_full_refresh",
    default_args=default_args,
    description="DBT transformation pipeline - Full Refresh",
    schedule_interval="@weekly",
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["dbt", "data-pipeline", "etl", "full-refresh"],
    doc_md=__doc__,
    max_active_runs=1,
)
...
def build_failure_message(context):
    ...
    message = f"""
:red_circle: *DBT Data Pipeline - FAILURE ALERT (Full Refresh)*
...
def build_success_message(context):
    ...
    message = f"""
:white_check_mark: *DBT Data Pipeline - Full Refresh Completed*
